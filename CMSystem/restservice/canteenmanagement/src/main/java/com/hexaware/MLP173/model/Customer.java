 ...
 */
  ...
  @Override
    ...
    if (Objects.equals(cusId, customer.cusId)
        ...
        && Objects.equals(cusMobile, customer.cusMobile)
        && Objects.equals(cusDob, customer.cusDob)
  ...
  @Override
    ...
    return Objects.hash(cusId, cusName, cusPassword, cusEmail, cusMobile, cusDob, cusAddress);
  }
    /**
     * @return this venId
     */
  ...
  */
  ...
  public final String toString() {
    return String.format("%5s %15s %25s %20s %20s %20s %20s", cusId, cusName, cusPassword, cusEmail, cusMobile, cusDob, cusAddress);
  }
}
